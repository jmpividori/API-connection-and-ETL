...
FechaIni = datetime(2023, 11, 30)   # fecha desde = año/mes/dia
...
with open('datos_finales.csv', 'r') as file:
    data = file.read()
with open('datos_finales.csv', 'w') as file:
    file.write(','.join(Nombres) + '\n' + data)

print("\nSe han descargado y agrupado todos los informes en 'datos_finales.csv'\n")